            ...
            <div class="col-lg-3 col-sm-6">
                <div class="bike-full-feat-card h-100 p-4 bg-white rounded-4 border shadow-sm">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <h3 class="h5 fw-bold text-navy m-0">24x7 CCTV Surveillance</h3>
                    </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="bike-full-feat-card h-100 p-4 bg-white rounded-4 border shadow-sm">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <h3 class="h5 fw-bold text-navy m-0">Pest &amp; Moisture Control</h3>
                    </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="bike-full-feat-card h-100 p-4 bg-white rounded-4 border shadow-sm">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <h3 class="h5 fw-bold text-navy m-0">Flexible Storage Leases</h3>
                    </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="bike-full-feat-card h-100 p-4 bg-white rounded-4 border shadow-sm">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <h3 class="h5 fw-bold text-navy m-0">Doorstep Pickup &amp; Return</h3>
                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="bike-step-grid-item h-100 p-4 rounded-4">
                        <div class="d-flex align-items-center gap-3 mb-3">
                            ...
                            <h3 class="h5 fw-bold text-navy m-0">Doorstep Packing &amp; Audit</h3>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="bike-step-grid-item h-100 p-4 rounded-4">
                        <div class="d-flex align-items-center gap-3 mb-3">
                            ...
                            <h3 class="h5 fw-bold text-navy m-0">Palletized Staging</h3>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="bike-step-grid-item h-100 p-4 rounded-4">
                        <div class="d-flex align-items-center gap-3 mb-3">
                            ...
                            <h3 class="h5 fw-bold text-navy m-0">Active Maintenance</h3>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="bike-step-grid-item h-100 p-4 rounded-4">
                        <div class="d-flex align-items-center gap-3 mb-3">
                            ...
                            <h3 class="h5 fw-bold text-navy m-0">Doorstep Delivery On-Demand</h3>
                        </div>
                        ...
                        <div class="d-flex flex-column gap-3">
                            <div class="p-3 rounded-3 bg-light border">
                                <div class="d-flex align-items-center gap-2 mb-2">
                                    ...
                                    <h4 class="h6 fw-bold text-navy m-0">Moisture Barrier &amp; Silica Gel Packs</h4>
                                </div>
                            ...
                            <div class="p-3 rounded-3 bg-light border">
                                <div class="d-flex align-items-center gap-2 mb-2">
                                    ...
                                    <h4 class="h6 fw-bold text-navy m-0">Elevated Pallet Staging Off Floor</h4>
                                </div>
                            ...
                            <div class="p-3 rounded-3 bg-light border">
                                <div class="d-flex align-items-center gap-2 mb-2">
                                    ...
                                    <h4 class="h6 fw-bold text-navy m-0">Digital Barcode Tracking System</h4>
                                </div>
            ...
            <div class="col-lg-6">
                <div class="bike-docs-card bg-white rounded-4 p-4 p-md-5 h-100 border shadow-sm d-flex flex-column justify-content-between">
                            ...
                            <div class="col-sm-6">
                                <div class="doc-card p-3 rounded-3 h-100">
                                    <div class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <h4 class="doc-title h6 m-0">No Perishable Items</h4>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="doc-card p-3 rounded-3 h-100">
                                    <div class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <h4 class="doc-title h6 m-0">Zero Inflammables</h4>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="doc-card p-3 rounded-3 h-100">
                                    <div class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <h4 class="doc-title h6 m-0">KYC Documentation</h4>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="doc-card p-3 rounded-3 h-100">
                                    <div class="d-flex align-items-center gap-2 mb-2">
                                        ...
                                        <h4 class="doc-title h6 m-0">24-48 Hr Retrieval</h4>
                                    </div>
                    ...
                    <div class="bike-cta-inline p-3 p-md-4 rounded-4 mt-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
                        <div>
                            <p class="fw-bold text-white m-0 h6">Need immediate storage space?</p>
                ...
                <div class="bike-testimonial-card rounded-4 p-4 p-md-5 h-100 border position-relative d-flex flex-column justify-content-between">
                    ...
                    <div class="bike-slider-wrapper position-relative flex-grow-1 d-flex flex-column justify-content-center my-2">
                        ...
                        <div class="bike-review-slide active" data-slide="0">
                            ...
                            <p class="fw-bold text-navy mb-3 fs-5">"Stored our 2BHK furniture for 6 months while traveling overseas!"</p>
                            ...
                            <div class="d-flex align-items-center gap-3 pt-3 border-top mt-3">
                                ...
                                <div>
                                    <strong class="m-0 fw-bold text-navy d-block">Pratik Bhowmik</strong>
                        ...
                        <div class="bike-review-slide" data-slide="1">
                            ...
                            <p class="fw-bold text-navy mb-3 fs-5">"Saved our furniture from interior renovation plaster and paint dust!"</p>
                            <p class="testimonial-quote-text fst-italic mb-3">
                            ...
                            <div class="d-flex align-items-center gap-3 pt-3 border-top mt-3">
                                ...
                                <div>
                                    <strong class="m-0 fw-bold text-navy d-block">Gaurav Saxena</strong>
                        ...
                        <div class="bike-review-slide" data-slide="2">
                            ...
                            <p class="fw-bold text-navy mb-3 fs-5">"Very cost-effective pallet storage for our seasonal stock!"</p>
                            <p class="testimonial-quote-text fst-italic mb-3">
                            ...
                            <div class="d-flex align-items-center gap-3 pt-3 border-top mt-3">
                                ...
                                <div>
                                    <strong class="m-0 fw-bold text-navy d-block">Rajeev Mehta</strong>
