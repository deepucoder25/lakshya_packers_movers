...
<!-- ==========================================================================
     Modern Hero Glassmorphism Slider Section - Split 2-Column Layout
     ========================================================================== -->
                  ...
                  <div class="hero-content-wrapper">
                    ...
                    <div class="hero-badge-wrapper text-start">
                      <div class="hero-trust-badge">
                        ...
                        <span class="badge-text">Trusted Relocation Partner Across India</span>
                      </div>
                    </div>

                    <!-- Main Heading -->
                    <h1 class="hero-glass-title text-start">
                      YOUR MOVE,<span class="text-highlight-orange">OUR RESPONSIBILITY</span>
                    </h1>

                    <!-- Subtitle Description -->
                    <p class="hero-glass-desc text-start ms-0">
                      Professional packing, safe loading and on-time delivery at your new destination.
                      We make your shifting smooth, secure and completely hassle-free.
                    </p>
                    ...
                    <div class="hero-features-grid text-start">
                      ...
                      <div class="hero-feature-item">
                        ...
                        <div class="hero-feature-text">
                          ...
                          <div class="feature-sub">Always On Time</div>
                        </div>
                      </div>
                      ...
                      <div class="hero-feature-item">
                        ...
                        <div class="hero-feature-text">
                          <div class="feature-title">Experienced Team</div>
                          <div class="feature-sub">Skilled &amp; Professional</div>
                        </div>
                      </div>
                      ...
                      <div class="hero-feature-item">
                        ...
                        <div class="hero-feature-text">
                          ...
                          <div class="feature-sub">Best Rates</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="hero-actions text-start justify-content-start">
                      ...
                      <a href="<?= site_url('about-us') ?>" class="btn-hero-secondary text-decoration-none" title="About Us">
                        About Us
                      </a>
                    </div>
                  </div>
                  ...
                  <div class="hero-content-wrapper">
                    ...
                    <div class="hero-badge-wrapper text-start">
                      <div class="hero-trust-badge">
                        ...
                        <span class="badge-text">Fast &amp; Insured Door-to-Door Relocation</span>
                      </div>
                    </div>

                    <!-- Main Heading -->
                    <h2 class="hero-glass-title text-start">
                      SAFE SHIFTING, <span class="text-highlight-orange">PEACE OF MIND</span>
                    </h2>

                    <!-- Subtitle Description -->
                    <p class="hero-glass-desc text-start ms-0">
                      Multi-layer premium packing materials and dedicated moving fleets across India.
                      Experience zero damage shifting with verified moving experts.
                    </p>
                    ...
                    <div class="hero-features-grid text-start">
                      <div class="hero-feature-item">
                        ...
                        <div class="hero-feature-text">
                          ...
                          <div class="feature-sub">Local &amp; Domestic</div>
                        </div>
                      </div>
                      ...
                      <div class="hero-feature-item">
                        ...
                        <div class="hero-feature-text">
                          <div class="feature-title">Vehicle Transport</div>
                      ...
                      <div class="hero-feature-item">
                        ...
                        <div class="hero-feature-text">
                          ...
                          <div class="feature-sub">Always Available</div>
                        </div>
                      </div>
                    </div>
