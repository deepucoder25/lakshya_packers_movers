...
<?php $this->load->view('about/dynamic_breadcrumbs', [
    'bc_h1' => 'Reliable Intercity Moving Services',
    'bc_desc' => 'Smooth, punctual, and fully insured long-distance household and commercial relocation across all states and cities in India.',
    'breadcrumbs' => [
    ...
    <div class="container position-relative z-2">
            ...
            <div class="row align-items-center g-4">
                <div class="col-lg-7">
                    <div class="svc-pill-badge d-inline-flex align-items-center justify-content-center mb-3">
                        ...
                        <span class="svc-badge-title">LONG DISTANCE INTERCITY RELOCATION</span>
                        <span class="svc-badge-dots" aria-hidden="true">
                            <i></i><i></i><i></i><i></i><i></i>
                        </span>
                    </div>
                    <h2 class="bike-heading-title fw-bolder">
                        Interstate &amp; Intercity Relocation by <span class="text-orange"><?= htmlspecialchars($company3) ?></span>
                    </h2>
                    <div class="bike-gold-divider d-flex align-items-center my-3">
                        <span class="divider-line"></span>
                        <span class="divider-diamond"><i class="bi bi-truck"></i></span>
                        <span class="divider-line"></span>
                    </div>
                    <p class="lead-text mb-3">
                        Moving to a new city hundreds or thousands of kilometers away? <strong><?= htmlspecialchars($company3) ?></strong> provides certified, hassle-free, and punctual long-distance relocation across India.
                    </p>
                    <p class="text-muted mb-0">
                        Long-haul transit demands superior packaging that withstands prolonged highway vibration and varying weather conditions. Our long-distance fleet consists of GPS-monitored, sealed container trucks operated by experienced highway drivers, ensuring your household belongings arrive safely and on schedule.
                    </p>
                </div>

                <div class="col-lg-5">
                    <div class="bike-banner-wrapper position-relative overflow-hidden rounded-4">
                        <img loading="lazy" src="<?= base_url('assets/img/packing_moving.jpg') ?>" alt="Interstate Long Distance Relocation by <?= htmlspecialchars($company3) ?>" class="img-fluid w-100 bike-featured-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bike-process-card bg-white rounded-4 p-4 p-md-5 mb-5 shadow-sm border">
            <div class="text-center svc-header-wrapper mb-4 mb-md-5">
                ...
                <h2 class="bike-heading-title fw-bolder mb-2">How We Handle <span class="text-orange">Intercity Relocation</span></h2>
                ...
                <p class="text-muted mx-auto bike-section-desc">
                    A well-structured interstate moving protocol ensuring documentation compliance, highway safety, and punctual delivery.
                </p>
            </div>
        ...
        <div class="row g-4 mb-5">
            <!-- Left: Intercity Packaging Protocol -->
            <div class="col-lg-6">
                <div class="bike-form-card bg-white rounded-4 p-4 p-md-5 h-100 border shadow-sm d-flex flex-column justify-content-between">
                    <div>
                        <div class="mb-2">
                            <span class="badge-sub-title"><i class="bi bi-shield-lock-fill"></i> LONG-HAUL SAFETY</span>
                        </div>
                        <h3 class="bike-sub-title fw-bold mb-2">Engineered Packaging <span class="text-orange">for Highway Transit</span></h3>
                        <p class="small text-muted mb-4">Interstate roads require heavy-duty reinforced packing materials to resist road vibrations:</p>
                    ...
                    <div class="mt-4 pt-3 border-top d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <span class="small text-muted"><i class="bi bi-check-circle-fill text-success me-1"></i> Certified Interstate Carrier</span>
            ...
            <div class="col-lg-6">
                <div class="bike-docs-card bg-white rounded-4 p-4 p-md-5 h-100 border shadow-sm d-flex flex-column justify-content-between">
                    <div>
                        <div class="mb-2">
                            <span class="badge-sub-title"><i class="bi bi-file-earmark-check-fill"></i> STATUTORY COMPLIANCE</span>
                        </div>
                        <h3 class="bike-sub-title fw-bold mb-2">Interstate Moving <span class="text-orange">Document Checklist</span></h3>
                        <p class="small text-muted mb-4">Required documents for interstate highway border checkposts and commercial clearances:</p>
