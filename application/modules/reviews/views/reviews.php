                                        ...
                                        ?>
                                            <div class="d-flex flex-wrap gap-2 mt-2 mb-3">
                                                <?php foreach($images as $img) { 
                                                    if(trim($img) !== '') {
                                                ?>
                                                    <img src="<?= base_url(trim($img)) ?>" loading="lazy" alt="Review Image" class="img-thumbnail shadow-sm review-img-clickable" onclick="openImageModal(this.src)" style="height: 60px; width: 60px; object-fit: cover; border-radius: 6px; border: 1px solid #ddd; cursor: pointer;">
                                                <?php } } ?>
                                            </div>
                                        <?php } ?>
  ...
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content bg-transparent border-0">
      ...
      <div class="modal-body text-center p-0">
        <img id="fullImage" src="" loading="lazy" class="img-fluid rounded shadow-lg" style="max-height: 85vh; object-fit: contain; max-width: 100%;">
      </div>
    </div>
  </div>
</div>
